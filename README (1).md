...
This project was developed במסגרת the **Data Science and Learning (DSL)** course at Politecnico di Torino. The goal is to predict monthly rental prices of apartments in the United States with minimal error by analyzing listing features.
